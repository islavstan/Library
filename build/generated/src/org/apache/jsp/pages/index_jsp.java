...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <p class=\"title\"><img src=\"images/111.jpg\" width=\"76\"\n");
      out.write("                                      height=\"77\" hspace=\"10\" vspace=\"10\"\n");
      out.write("                                      align=\"middle\"</p>\n");
      out.write("                <p class=\"title\">Онлайн библиотека</p>\n");
      out.write("                <p class=\"text\">Добро пожаловать в онлайн библиотеку, где вы \n");
      out.write("                    сможете найти любую книгу на ваш вкус. Доступны функции поиска, просмотра, сортировки и многие другие.</p>\n");
      out.write("            <p class=\"text\">Проект находится в разработке, поэтому дизайн и функционал будет постоянно дорабатываться.</p>\n");
      out.write("            <p class=\"text\">По всем вопросам обращайтесь по адресу <a href=\"mailto:islavstan@gmail.com\">islavstan@gmail.com</a></p>\n");
      out.write("                <p>&nbsp;</p>\n");
      out.write("  </div>\n");
      out.write("\n");
      ...
      out.write("                Разработчик: Стас Горобец, 2016г.\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("\n");
      out.write("\n");
